...
{
    internal class WordGridPresenter_old : Presenter_old<WordGridViewAdapter>
    {
        public WordGridPresenter_old(IProjectService service, WordGridViewAdapter view) :
            base(service, view)
        { }
        ...
        protected override void UpdateView()
        {
            ...
            {
                View.AllCategories = categories.Select(e => e.Value.Record);
                View.AllLanguages = languages.Select(e => e.Value.Record);
                View.Render(sections.Values);
            }
        }
    }
}
